...
public class StudentTestPage extends JComponent implements PageInteface {
	...
	public StudentTestPage() {
		...
		add(beginTestButton, new GBC(0, 2).setWeight(0, 0).setAnchor(GBC.CENTER));
		add(logo, new GBC(0, 1).setWeight(100, 100).setAnchor(GBC.CENTER));
		add(testInformation, new GBC(0, 3).setWeight(100, 100).setAnchor(GBC.CENTER));
